...
export interface PdfiumRenameFormFieldResultP {
    'result'?: (string);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "result" | "exception";
}
export interface PdfiumRenameFormFieldResultP__Output {
    'result'?: (string);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=PdfiumRenameFormFieldResultP.d.ts.map
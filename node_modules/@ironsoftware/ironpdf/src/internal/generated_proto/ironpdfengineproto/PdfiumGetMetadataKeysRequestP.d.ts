...
export interface PdfiumGetMetadataKeysRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
}
export interface PdfiumGetMetadataKeysRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
}
//# sourceMappingURL=PdfiumGetMetadataKeysRequestP.d.ts.map
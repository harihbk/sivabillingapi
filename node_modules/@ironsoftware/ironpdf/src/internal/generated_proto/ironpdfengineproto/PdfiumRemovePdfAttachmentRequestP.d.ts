...
export interface PdfiumRemovePdfAttachmentRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'index'?: (number);
}
export interface PdfiumRemovePdfAttachmentRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'index'?: (number);
}
//# sourceMappingURL=PdfiumRemovePdfAttachmentRequestP.d.ts.map
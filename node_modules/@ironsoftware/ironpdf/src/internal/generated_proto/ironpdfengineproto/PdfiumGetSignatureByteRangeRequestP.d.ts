...
export interface PdfiumGetSignatureByteRangeRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'index'?: (number);
}
export interface PdfiumGetSignatureByteRangeRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'index'?: (number);
}
//# sourceMappingURL=PdfiumGetSignatureByteRangeRequestP.d.ts.map
...
export interface PdfiumGetBookmarksDescriptorRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
}
export interface PdfiumGetBookmarksDescriptorRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
}
//# sourceMappingURL=PdfiumGetBookmarksDescriptorRequestP.d.ts.map
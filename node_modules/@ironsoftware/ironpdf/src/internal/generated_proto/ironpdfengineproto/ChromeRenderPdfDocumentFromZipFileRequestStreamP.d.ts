...
export interface _ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP_InfoP__Output {
    'mainFile'?: (string);
...
export interface ChromeRenderPdfDocumentFromZipFileRequestStreamP {
    'info'?: (_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP_InfoP | null);
    'zipChunk'?: (Buffer | Uint8Array | string);
    'request'?: "info" | "zipChunk";
}
export interface ChromeRenderPdfDocumentFromZipFileRequestStreamP__Output {
    'info'?: (_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP_InfoP__Output);
    'zipChunk'?: (Buffer);
}
//# sourceMappingURL=ChromeRenderPdfDocumentFromZipFileRequestStreamP.d.ts.map
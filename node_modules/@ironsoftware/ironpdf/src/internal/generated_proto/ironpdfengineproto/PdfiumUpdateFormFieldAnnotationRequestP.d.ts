...
export interface PdfiumUpdateFormFieldAnnotationRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'formObject'?: (_ironpdfengineproto_PdfiumIFormFieldObjectP | null);
    'annot'?: (_ironpdfengineproto_PdfiumIFormFieldAnnotationP | null);
}
export interface PdfiumUpdateFormFieldAnnotationRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'formObject'?: (_ironpdfengineproto_PdfiumIFormFieldObjectP__Output);
    'annot'?: (_ironpdfengineproto_PdfiumIFormFieldAnnotationP__Output);
}
//# sourceMappingURL=PdfiumUpdateFormFieldAnnotationRequestP.d.ts.map
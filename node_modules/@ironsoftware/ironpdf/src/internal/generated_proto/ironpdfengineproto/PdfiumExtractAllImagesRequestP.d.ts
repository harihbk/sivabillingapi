...
export interface PdfiumExtractAllImagesRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'pageIndexes'?: (number)[];
}
export interface PdfiumExtractAllImagesRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'pageIndexes'?: (number)[];
}
//# sourceMappingURL=PdfiumExtractAllImagesRequestP.d.ts.map
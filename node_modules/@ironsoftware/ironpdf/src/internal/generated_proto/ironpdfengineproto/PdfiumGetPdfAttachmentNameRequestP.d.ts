...
export interface PdfiumGetPdfAttachmentNameRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'index'?: (number);
}
export interface PdfiumGetPdfAttachmentNameRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'index'?: (number);
}
//# sourceMappingURL=PdfiumGetPdfAttachmentNameRequestP.d.ts.map
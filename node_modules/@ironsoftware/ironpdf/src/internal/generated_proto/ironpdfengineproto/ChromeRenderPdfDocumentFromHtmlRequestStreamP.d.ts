...
export interface _ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP_InfoP {
...
export interface _ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP_InfoP__Output {
...
export interface ChromeRenderPdfDocumentFromHtmlRequestStreamP {
    'info'?: (_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP_InfoP | null);
    'htmlChunk'?: (string);
    'request'?: "info" | "htmlChunk";
}
export interface ChromeRenderPdfDocumentFromHtmlRequestStreamP__Output {
    'info'?: (_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP_InfoP__Output);
    'htmlChunk'?: (string);
}
//# sourceMappingURL=ChromeRenderPdfDocumentFromHtmlRequestStreamP.d.ts.map
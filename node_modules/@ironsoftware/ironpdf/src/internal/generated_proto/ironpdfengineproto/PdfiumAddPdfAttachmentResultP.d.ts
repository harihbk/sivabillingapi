...
export interface PdfiumAddPdfAttachmentResultP {
    'result'?: (number);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "result" | "exception";
}
export interface PdfiumAddPdfAttachmentResultP__Output {
    'result'?: (number);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=PdfiumAddPdfAttachmentResultP.d.ts.map
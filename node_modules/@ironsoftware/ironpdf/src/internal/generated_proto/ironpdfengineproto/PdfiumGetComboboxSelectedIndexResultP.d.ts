...
export interface PdfiumGetComboboxSelectedIndexResultP {
    'result'?: (number);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "result" | "exception";
}
export interface PdfiumGetComboboxSelectedIndexResultP__Output {
    'result'?: (number);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=PdfiumGetComboboxSelectedIndexResultP.d.ts.map
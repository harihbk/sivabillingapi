...
export interface PdfiumGetFormFieldValueResultP {
    'result'?: (string);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "result" | "exception";
}
export interface PdfiumGetFormFieldValueResultP__Output {
    'result'?: (string);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=PdfiumGetFormFieldValueResultP.d.ts.map
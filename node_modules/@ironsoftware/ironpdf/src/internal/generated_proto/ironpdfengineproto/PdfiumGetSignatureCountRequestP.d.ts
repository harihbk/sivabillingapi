...
export interface PdfiumGetSignatureCountRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
}
export interface PdfiumGetSignatureCountRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
}
//# sourceMappingURL=PdfiumGetSignatureCountRequestP.d.ts.map
...
export interface PdfiumRemoveStructTreeRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
}
export interface PdfiumRemoveStructTreeRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
}
//# sourceMappingURL=PdfiumRemoveStructTreeRequestP.d.ts.map
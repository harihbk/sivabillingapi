...
export interface HandshakeResponseP {
    'success'?: (_ironpdfengineproto_EmptyP | null);
    'requiredVersion'?: (string);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "success" | "requiredVersion" | "exception";
}
export interface HandshakeResponseP__Output {
    'success'?: (_ironpdfengineproto_EmptyP__Output);
    'requiredVersion'?: (string);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=HandshakeResponseP.d.ts.map
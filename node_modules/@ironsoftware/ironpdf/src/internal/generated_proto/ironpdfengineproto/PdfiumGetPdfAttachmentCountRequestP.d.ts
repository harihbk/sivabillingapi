...
export interface PdfiumGetPdfAttachmentCountRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
}
export interface PdfiumGetPdfAttachmentCountRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
}
//# sourceMappingURL=PdfiumGetPdfAttachmentCountRequestP.d.ts.map
...
export interface PdfiumGetComboboxOptionsRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'annotationIndex'?: (number);
    'pageIndex'?: (number);
}
export interface PdfiumGetComboboxOptionsRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'annotationIndex'?: (number);
    'pageIndex'?: (number);
}
//# sourceMappingURL=PdfiumGetComboboxOptionsRequestP.d.ts.map
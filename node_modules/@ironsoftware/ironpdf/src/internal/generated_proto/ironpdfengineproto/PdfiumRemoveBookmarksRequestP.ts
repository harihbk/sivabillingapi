...
export interface PdfiumRemoveBookmarksRequestP {
  'document'?: (_ironpdfengineproto_PdfDocumentP | null);
  'bookmarks'?: (_ironpdfengineproto_PdfBookmarkCollectionP | null);
  '_bookmarks'?: "bookmarks";
}

export interface PdfiumRemoveBookmarksRequestP__Output {
  'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
  'bookmarks'?: (_ironpdfengineproto_PdfBookmarkCollectionP__Output);
}

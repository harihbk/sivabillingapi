...
export interface _ironpdfengineproto_ChromeRenderMeasureHtmlRequestStreamP_InfoP {
...
export interface _ironpdfengineproto_ChromeRenderMeasureHtmlRequestStreamP_InfoP__Output {
...
export interface ChromeRenderMeasureHtmlRequestStreamP {
    'info'?: (_ironpdfengineproto_ChromeRenderMeasureHtmlRequestStreamP_InfoP | null);
    'htmlChunk'?: (string);
    'request'?: "info" | "htmlChunk";
}
export interface ChromeRenderMeasureHtmlRequestStreamP__Output {
    'info'?: (_ironpdfengineproto_ChromeRenderMeasureHtmlRequestStreamP_InfoP__Output);
    'htmlChunk'?: (string);
}
//# sourceMappingURL=ChromeRenderMeasureHtmlRequestStreamP.d.ts.map
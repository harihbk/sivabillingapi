...
export interface PdfiumGetFormFieldIsReadOnlyResultP {
    'result'?: (boolean);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "result" | "exception";
}
export interface PdfiumGetFormFieldIsReadOnlyResultP__Output {
    'result'?: (boolean);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=PdfiumGetFormFieldIsReadOnlyResultP.d.ts.map
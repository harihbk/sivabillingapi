...
export interface PdfiumExtractAllTextRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
    'pageIndexes'?: (number)[];
    'isLicense'?: (boolean);
    '_isLicense'?: "isLicense";
}
export interface PdfiumExtractAllTextRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
    'pageIndexes'?: (number)[];
    'isLicense'?: (boolean);
}
//# sourceMappingURL=PdfiumExtractAllTextRequestP.d.ts.map
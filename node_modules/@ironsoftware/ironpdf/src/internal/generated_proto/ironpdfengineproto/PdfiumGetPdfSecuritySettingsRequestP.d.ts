...
export interface PdfiumGetPdfSecuritySettingsRequestP {
    'document'?: (_ironpdfengineproto_PdfDocumentP | null);
}
export interface PdfiumGetPdfSecuritySettingsRequestP__Output {
    'document'?: (_ironpdfengineproto_PdfDocumentP__Output);
}
//# sourceMappingURL=PdfiumGetPdfSecuritySettingsRequestP.d.ts.map
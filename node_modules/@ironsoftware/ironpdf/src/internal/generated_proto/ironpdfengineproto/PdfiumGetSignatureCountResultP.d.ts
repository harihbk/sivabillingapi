...
export interface PdfiumGetSignatureCountResultP {
    'result'?: (number);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP | null);
    'resultOrException'?: "result" | "exception";
}
export interface PdfiumGetSignatureCountResultP__Output {
    'result'?: (number);
    'exception'?: (_ironpdfengineproto_RemoteExceptionP__Output);
}
//# sourceMappingURL=PdfiumGetSignatureCountResultP.d.ts.map